namespace DevTKSS.Extensions.Uno.Enumerable;
internal static class EnumerableExtensions
{
    ...
    /// The start index specifies the first line to include, and the end index specifies the last line to include.
    /// </param>
    /// <returns>
    ...
    /// <summary>
    /// Retrieves a single string containing the concatinated items within the specified range.
    /// </summary>
